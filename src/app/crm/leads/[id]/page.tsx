          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {lead.email && (
              <a
                ...
                className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#f4f4f4] hover:bg-[#3ab874] hover:text-white text-[#5c5c5c] transition-colors"
                title="Send email"
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><rect x="1" y="3" width="12" height="9" rx="1.5" stroke="currentColor" strokeWidth="1.2"/><path d="M1 4.5l6 4 6-4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>
              </a>
            )}
            {lead.phone && (
              <a
                ...
                title="Call"
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 2.5C2 2 2.5 1.5 3 1.5h2l1 3-1.5 1A8 8 0 0 0 8.5 9.5L10 8l3 1v2c0 .5-.5 1-1 1C5 12 2 7 2 2.5z" stroke="currentColor" strokeWidth="1.2"/></svg>
              </a>
            )}
            {lead.phone && (
              <a
                ...
                className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#f4f4f4] hover:bg-[#25d366] hover:text-white text-[#5c5c5c] transition-colors"
                title="WhatsApp"
              >
